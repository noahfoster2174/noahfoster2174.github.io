...
## Status
Live-data upgrade shipped 2026-07-12: weekly mileage graph + honest average on feed (from strava-history.json, client-built SVG), commit-activity signals on Currently Building (github.json), health-check monitoring, real OG image (assets/og.png), zero external runtime dependencies except Google Fonts. Homepage simplified 2026-07-13 to a plain intro — all live data now lives on the feed.
